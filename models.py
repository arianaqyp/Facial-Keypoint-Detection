...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, 10, 2)            # in: (1, 224, 224),    out: (32, 108, 108),    pooled out: (32, 54, 54)
        self.pool = nn.MaxPool2d(2, 2)
        self.batchnorm1 = nn.BatchNorm2d(32)

        self.conv2 = nn.Conv2d(32, 64, 5, 2)            # out: (64, 25, 25),    pooled out: (64, 12, 12)
        self.batchnorm2 = nn.BatchNorm2d(64)

        self.conv3 = nn.Conv2d(64, 128, 5)              # out: (128, 8, 8),     pooled out: (128, 4, 4)
        self.batchnorm3 = nn.BatchNorm2d(128)

        self.conv4 = nn.Conv2d(128, 256, 3)             # out: (256, 2, 2),     pooled out: (256, 1, 1)
